...
/**
* @version		$Id: saldilijsten.php 289 2015-01-04 09:09:40Z otto $
...
switch($aktie) {
  case "printproefbalans"  :
    $printen = true;
    require("_proefbalans-pdf.inc");
    break;
  case "proefbalans"  :
    define('RUBRIEK','Balansen');
    require("_proefbalans.inc");
    break;
  case "printsaldibalans"  :
    require("_saldibalans-pdf.inc");
    $printen = true;
    break;
  case "saldibalans"  :
  default       :
    define('RUBRIEK','Balansen');
    require("_saldibalans.inc");
    break;
}
