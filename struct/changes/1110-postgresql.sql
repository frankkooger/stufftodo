...
--
--
-- LET OP! Deze veranderingen aan de tabellen "boekregels", "boekregelsTrash" en "journaal" moeten in postgresql met de hand gebeuren!
--
...
-- ---------------------------------------
-- SQLVERSIE 1.11.0 <- 1.10.1
-- ---------------------------------------

-- Nieuwe btwkeys toegevoegd: 
--	verkopen_privegebruik 
--	verkopen_hoog
--	verkopen_laag

INSERT INTO btwkeys("key", "type", "actief", "ccode", "labelstam", "boekjaar", "active")
    VALUES ('verkopen_privegebruik', 'sal', 1, '1d', 'Omzet privégebruik', 2008, 1);
INSERT INTO btwkeys("key", "type", "actief", "ccode", "labelstam", "boekjaar", "active")
    VALUES ('verkopen_hoog', 'sal', 1, '1a', 'Verkopen BTW hoog', 2008, 1);
INSERT INTO btwkeys("key", "type", "actief", "ccode", "labelstam", "boekjaar", "active")
    VALUES ('verkopen_laag', 'sal', 1, '1b', 'Verkopen BTW laag', 2008, 1);

UPDATE "meta" SET "value"='1.11.0' WHERE "key"='sqlversie';
