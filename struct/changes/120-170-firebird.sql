...
CREATE UNIQUE INDEX "btk_prima" ON "btwkeys" ("key", "ccode");
COMMIT;
...
-- Aanpassing van "grootboekstam". De kolom "btwtype" gaat heten "btwdefault" en een nieuwe kolom "btwtype" is een varchar(32)
--
-- postgresql
ALTER TABLE "grootboekstam" ALTER COLUMN "btwtype" TO "btwdefaults";
ALTER TABLE "grootboekstam" ADD "btwtype" VARCHAR( 32 ) DEFAULT '';
ALTER TABLE "grootboekstam" ADD "btwdefault" VARCHAR( 32 ) DEFAULT '';

ALTER TABLE "grootboekstam2009" ALTER COLUMN "btwtype" TO "btwdefaults";
...
ALTER TABLE "grootboekstam2008" ALTER COLUMN "btwtype" TO "btwdefaults";
...
ALTER TABLE "grootboekstam" ALTER COLUMN "btwtype" TO "btwkey";
ALTER TABLE "grootboekstam2009" ALTER COLUMN "btwtype" TO "btwkey";
ALTER TABLE "grootboekstam2008" ALTER COLUMN "btwtype" TO "btwkey";
