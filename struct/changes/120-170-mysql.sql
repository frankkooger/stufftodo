...
CREATE TEMPORARY TABLE "temp" SELECT MAX(id) +1 AS id FROM "stamgegevens";

INSERT INTO "stamgegevens" VALUES((SELECT "id" FROM "temp"), 2008,'e',26,'Verkopen geen BTW','rkg_verkoopgeenbtw','0','');
...
INSERT INTO "stamgegevens" ("id", "boekjaar", "code", "subcode", "label", "naam", "value", "tekst") 
  VALUES ((SELECT "id" FROM "temp"), '2010', 'e', '22', 'Rekening BTW autokosten', 'rkg_btwautokosten', '', '');
...
INSERT INTO "btwaangiftelabels" ("key", "label") VALUES
('rkg_btwinkopen', '5b. Voorbelasting'),
('rkg_btwverkoophoog', '1a. Leveringen/diensten belast met hoog tarief'),
('rkg_btwverkooplaag', '1b. Leveringen/diensten belast met laag tarief'),
('verkopen_verlegdebtw', '1e. Leveringen/diensten verlegde of 0% BTW'),
('subtotaal5a', '5a. Verschuldigde omzetbelasting'),
('totaal5e', '5e. Totaal'),
('subtotaal5c', '5c. Subtotaal: 5a min 5b'),
('vermindering5d', '5d. Vermindering volgens kleinondernemersregeling'),
('verkopen_geenbtw', '01e. Leveringen/diensten met 0% BTW'),
('rkg_btwautokosten', '05b. Voorbelasting autokosten');
...
ALTER TABLE "btwkeys" ADD UNIQUE "btk_prima"("key","ccode");
...
ALTER TABLE "grootboekstam2008" CHANGE "btwtype" "btwdefaults" INT( 11 ) NOT NULL DEFAULT '0' COMMENT '1.inkopen/3.verkoophoog/4.verkooplaag/5.geenbtw/6.verlegdebtw';
...
ALTER TABLE "grootboekstam" CHANGE "btwtype" "btwdefaults" INT( 11 ) NOT NULL DEFAULT '0' COMMENT '1.inkopen/3.verkoophoog/4.verkooplaag/5.geenbtw/6.verlegdebtw';
...
-- SQLVERSIE 1.5.0 -> 1.6.0

ALTER TABLE "grootboekstam" CHANGE "btwtype" "btwkey" varchar(32);
ALTER TABLE "grootboekstam2008" CHANGE "btwtype" "btwkey" varchar(32);
