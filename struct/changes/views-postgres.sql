...
-- 20 aug 2011
-- 09 jul 2013
-- Bijgewerkt tot 1.16.6 (versie met kostenplaatsen). !!Is versie 1.16.7 geworden
-- 11 okt 2014
-- database versienummer bijgewerkt tot 1.16.7 i.v.m. toevoegen tabel "kostenplaatsen"
-- 14 dec 2014
-- database versienummer bijgewerkt tot 1.17.0 i.v.m. toevoegen tabel "kostenplaatsen"
-- en changes in de code die kostenplaatsen nodig hebben.
...
UNION ALL -- Ingeval we werken met inkopen/verkopen met zowel hoge als vrijgestelde BTW
...
--   2. Het totaal afgedragen en nog af te dragen betaalde BTW: de positieve 5c bedragen. Niet 5e want hier is evt. eerder verrekende 5d al af.
...
-- kunnen verrekenen. 
--
CREATE OR REPLACE VIEW vw_btw5d_calculus AS
SELECT
  SUM(btwbedrag) As "btwbedrag"
...
CREATE OR REPLACE VIEW "vw_kostenmatrix" AS
SELECT 
